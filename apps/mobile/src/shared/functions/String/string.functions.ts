...
export function updateCase(
  ...
  switch (caseType) {
    ...
    case 'snake':
      transformedText =
        textToTransform?.replace(/\s+/g, '_').toLowerCase() ?? '';
      break;
    ...
    case 'kebab':
      transformedText =
        textToTransform?.replace(/\s+/g, '-').toLowerCase() ?? '';
      break;
  }
 ...
 */
export function joinStringsWithBullet(
  strings: string[],
...
export function joinStringWithDash(
