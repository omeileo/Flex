  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerRow}>
        <Text style={styles.title}>{t('designPreview.activeWorkout.restTitle')}</Text>
        <Pressable style={styles.skipButton} onPress={onSkip}>
          <Text style={styles.skipLabel}>{t('designPreview.activeWorkout.skipRest')}</Text>
        </Pressable>
      </View>
      ...
      <View style={styles.adjustRow}>
        <Pressable style={styles.adjustButton} onPress={() => onAdjust(-10)}>
          <Text style={styles.adjustLabel}>{t('designPreview.activeWorkout.restMinus')}</Text>
        </Pressable>
        <Pressable style={styles.adjustButton} onPress={() => onAdjust(10)}>
          <Text style={styles.adjustLabel}>{t('designPreview.activeWorkout.restPlus')}</Text>
        </Pressable>
      </View>
