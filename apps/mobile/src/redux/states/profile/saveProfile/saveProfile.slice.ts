...
export const saveProfile = createAsyncThunk('profile/saveProfile', async (request: FitnessProfileUpsert, { rejectWithValue }) => {
  try {
...
export const { actions: saveProfileActions, reducer: saveProfileReducer } = saveProfileSlice
