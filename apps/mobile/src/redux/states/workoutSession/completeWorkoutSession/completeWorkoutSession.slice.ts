...
export const completeWorkoutSession = createAsyncThunk(
  ...
  async (request: { sessionId: string; body: WorkoutSessionComplete }, { rejectWithValue }) => {
    try {
...
export const { actions: completeWorkoutSessionActions, reducer: completeWorkoutSessionReducer } =
