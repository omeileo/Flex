...
export const completeWorkoutSession = createAsyncThunk('workoutSession/completeWorkoutSession', async (request: { sessionId: number, body: WorkoutSessionComplete }, { rejectWithValue }) => {
  try {
...
export const { actions: completeWorkoutSessionActions, reducer: completeWorkoutSessionReducer } = completeWorkoutSessionSlice
