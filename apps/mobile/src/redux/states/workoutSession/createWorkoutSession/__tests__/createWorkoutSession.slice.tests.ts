...
const { createWorkoutSessionApi } = jest.requireMock('../createWorkoutSession.api')

const buildStore = () => configureStore({ reducer: { createWorkoutSession: createWorkoutSessionReducer } })
