...
export const createWorkoutSessionApi = async (request: WorkoutSessionCreate): Promise<Record<string, unknown>> => {
  return getFlexApi().createWorkoutSession(request) as Promise<Record<string, unknown>>
}
