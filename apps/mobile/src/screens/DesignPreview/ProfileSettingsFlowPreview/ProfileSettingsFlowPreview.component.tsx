...
const goalOptions = ['Build muscle', 'Lose fat', 'Endurance', 'Return from injury']
...
const ProfileSettingsFlowPreviewComponent = (_props: ProfileSettingsFlowPreviewComponentProps) => {
  ...
  const [conditionStatus, setConditionStatus] = useState<'recovered' | 'managing' | 'flareUp'>('managing')
  ...
  const renderHub = () => (
    <>
      <Text style={styles.title}>{t('designPreview.profileSettings.hubTitle')}</Text>
      <View style={styles.hero}>
        ...
        <View>
          ...
          <Text style={styles.heroMeta}>{t('designPreview.profileSettings.memberSince')}</Text>
        </View>
      </View>
      <Text style={styles.sectionLabel}>{t('designPreview.profileSettings.trainingSection')}</Text>
      <ProfileSectionRow
      ...
      <ProfileSectionRow
        ...
        onPress={() => undefined}
      />
      <Text style={styles.sectionLabel}>{t('designPreview.profileSettings.wellnessSection')}</Text>
      <ProfileSectionRow
      ...
      />
      <Text style={styles.sectionLabel}>{t('designPreview.profileSettings.bodySection')}</Text>
      <ProfileSectionRow
      ...
      <ProfileSectionRow
        ...
        onPress={() => undefined}
      />
      <Text style={styles.footerNote}>{t('designPreview.profileSettings.footerNote')}</Text>
    </>
  )

  const renderGoals = () => (
    <>
      <Text style={styles.title}>{t('designPreview.profileSettings.goalsTitle')}</Text>
      <Text style={styles.fieldLabel}>{t('designPreview.profileSettings.goalsLabel')}</Text>
      ...
      <Text style={styles.fieldLabel}>{t('designPreview.profileSettings.experienceLabel')}</Text>
      <SelectionCard label="Intermediate" selected onPress={() => undefined} />
      <Text style={styles.subtitle}>{t('designPreview.profileSettings.schedulePreview')}</Text>
      <PrimaryButton label={t('designPreview.profileSettings.save')} onPress={() => setView('readapt')} />
    </>
  )

  const renderWellness = () => (
    <>
      <Text style={styles.title}>{t('designPreview.profileSettings.wellnessTitle')}</Text>
      <Text style={styles.subtitle}>{t('designPreview.profileSettings.wellnessSubtitle')}</Text>
      ...
      <PrimaryButton label={t('designPreview.profileSettings.addCondition')} onPress={() => undefined} />
    </>
  )

  const renderConditionDetail = () => (
    <>
      <Text style={styles.title}>{t('designPreview.profileSettings.conditionTitle')}</Text>
      <Text style={styles.fieldLabel}>{t('designPreview.profileSettings.statusLabel')}</Text>
      <StatusSegment value={conditionStatus} onChange={setConditionStatus} />
      <Text style={styles.fieldLabel}>{t('designPreview.profileSettings.restrictionsLabel')}</Text>
      <View style={styles.chipRow}>
      ...
      <Text style={styles.fieldLabel}>{t('designPreview.profileSettings.aggravatorsLabel')}</Text>
      <Text style={styles.subtitle}>{t('designPreview.profileSettings.aggravatorsSubtitle')}</Text>
      ...
      <Text style={[styles.fieldLabel, styles.fieldLabelNoTop]}>{t('designPreview.profileSettings.addExercise')}</Text>
      <View style={styles.coachCard}>
        <Text style={styles.coachLabel}>{t('designPreview.profileSettings.coachLabel')}</Text>
        <Text style={styles.coachText}>{t('designPreview.profileSettings.coachInsight')}</Text>
      </View>
      <View style={styles.footer}>
        <PrimaryButton label={t('designPreview.profileSettings.saveChanges')} onPress={() => setView('readapt')} />
      </View>
    </>
  )
  ...
  const renderExcluded = () => (
    <>
      <Text style={styles.title}>{t('designPreview.profileSettings.excludedTitle')}</Text>
      <Text style={styles.subtitle}>{t('designPreview.profileSettings.excludedSubtitle')}</Text>
      ...
      <Text style={styles.footerNote}>{t('designPreview.profileSettings.excludedLink')}</Text>
    </>
  )
  ...
  const renderReadapt = () => (
    <View style={styles.deleteSheetContainer}>
      ...
      <View style={styles.sheet}>
        <Text style={styles.sheetTitle}>{t('designPreview.profileSettings.readaptTitle')}</Text>
        <Text style={styles.subtitle}>{t('designPreview.profileSettings.readaptSubtitle')}</Text>
        <PrimaryButton label={t('designPreview.profileSettings.readaptCta')} onPress={() => setView('hub')} />
        <Pressable onPress={() => setView('hub')}>
          <Text style={styles.linkText}>{t('designPreview.profileSettings.readaptSkip')}</Text>
        </Pressable>
      </View>
    </View>
  )
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      <View style={styles.viewChips}>
        ...
        {renderViewChip('wellness', t('designPreview.profileSettings.wellnessChip'))}
        {renderViewChip('conditionDetail', t('designPreview.profileSettings.conditionChip'))}
        {renderViewChip('excluded', t('designPreview.profileSettings.excludedChip'))}
        {renderViewChip('readapt', t('designPreview.profileSettings.readaptChip'))}
      </View>
