    ...
    >
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>
          {t('designPreview.hub.onboardingTitle')}
        </Text>
        <Text style={styles.cardMeta}>
          {t('designPreview.hub.onboardingMeta')}
        </Text>
        <PrimaryButton
          label={t('designPreview.hub.openFlow')}
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>
          {t('designPreview.hub.trainingPlanTitle')}
        </Text>
        <Text style={styles.cardMeta}>
          {t('designPreview.hub.trainingPlanMeta')}
        </Text>
        <PrimaryButton
          label={t('designPreview.hub.openFlow')}
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>
          {t('designPreview.hub.activeWorkoutTitle')}
        </Text>
        <Text style={styles.cardMeta}>
          {t('designPreview.hub.activeWorkoutMeta')}
        </Text>
        <PrimaryButton
          label={t('designPreview.hub.openFlow')}
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>
          {t('designPreview.hub.gymLocationsTitle')}
        </Text>
        <Text style={styles.cardMeta}>
          {t('designPreview.hub.gymLocationsMeta')}
        </Text>
        <PrimaryButton
          label={t('designPreview.hub.openFlow')}
          onPress={onOpenGymLocations}
        />
      </View>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>
          {t('designPreview.hub.profileSettingsTitle')}
        </Text>
        <Text style={styles.cardMeta}>
          {t('designPreview.hub.profileSettingsMeta')}
        </Text>
        <PrimaryButton
          label={t('designPreview.hub.openFlow')}
